    ...
    <div class="layout-max spacer--vertical center-left">
      ...
      <div class="spacer clearfix">
        ...
        <ul class="list-inline">
          <li class="list-inline__item"><a href="https://twitter.com/artsculturegov" target="_blank" class="underline-on-hover__never"><img src="<?php print base_path() . drupal_get_path('theme', 'doca_theme'); ?>/images/social/twitter.svg" alt="Follow @artsculturegov on Twitter" /></a></li>
