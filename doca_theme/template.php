    ...
    if ($variables['elements']['#bundle'] === 'subscribe_block') {
      drupal_add_js(array(
        'doca_theme' => array(
          ...
          'errorMessage' => variable_get('doca_theme_error_message', t('Please check your email address and try again, if you are still having issues please <a href="mailto:media@communications.gov.au">email us</a> your details.')),
